...
//1- What’s the correlation between "song_hotness" AND "artist_hotness"
 ...
 Hotness := (SORT(MSDMusic, song_hotness),1000);
 Popularity := (SORT(MSDMusic, artist_hotness),1000);
 relation := CORRELATION(Hotness, Popularity);
 OUTPUT(relation, NAMED('Correlation'));
